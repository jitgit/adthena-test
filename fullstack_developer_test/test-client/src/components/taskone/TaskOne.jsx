  ...
  return (
    <div className="task">
      ...
      <div className="content">
        ...
        <p>
          This task is to solve a bug. There is a bug in the LogSelectionButton
          React Class Component that is preventing the behaviour described below
          from working correctly.
        </p>
        <p>Fix the bug. </p>
        Expected:
        <ol type="1">
          <li>LogSelectionButton must remain a Class Component.</li>
          <li>
